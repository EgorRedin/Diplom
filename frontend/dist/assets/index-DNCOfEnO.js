...
`,e5=h.div`
      ...
      padding-right: 12px;
      gap: 8px;
`,t5=({chatPhoto:e,chatName:t,chatId:n,setIsVisible:r,setChat:i})=>{const s=vt(),o=mi.actions.setChats,a=we(S=>S.chatsReducer.chats.find(v=>v.id===n)),l=we(S=>S.projectsReducer.projects),u=we(S=>S.userReducer.user),d=[];l.map(S=>{S.members.map(v=>{!d.find(m=>m.id===v.id)&&v.id!==u.id&&d.push(v)})});const[f,p]=b.useState(!1),g=b.useRef(null);b.useEffect(()=>{const S=({target:v})=>{var m;(m=g.current)!=null&&m.contains(v)||(console.log(v),r(!1))};return document.addEventListener("mousedown",S),()=>{document.removeEventListener("mousedown",S)}},[r]);const x=()=>{const S=window.localStorage.getItem("access_token");S&&A6(S,n).then(v=>{v.status===200&&Dr(S).then(m=>{m.status===200&&(i(void 0),s(o(m.data.chats)))}).catch(m=>console.log(m))}).catch(v=>console.log(v))},y=()=>{const S=window.localStorage.getItem("access_token");S&&F6(S,n).then(v=>{v.status===200&&Dr(S).then(m=>{m.status===200&&(i(void 0),s(o(m.data.chats)))}).catch(m=>console.log(m))}).catch(v=>console.log(v))};return c.jsxs(U6,{ref:g,children:[c.jsxs(H6,{children:[e&&c.jsx(Or,{style:{width:"56px",height:"56px"},src:`${X}/${e}`}),!e&&c.jsx(Or,{style:{width:"56px",height:"56px"}}),c.jsxs(Y6,{children:[c.jsx(q6,{children:t}),a.type==="group"&&c.jsxs(V6,{children:[a.members.length," участников"]})]})]}),c.jsx(A0,{style:{marginTop:"12px"}}),c.jsxs(G6,{style:{marginTop:"12px"},children:[c.jsx(F0,{children:"Уведомления"}),c.jsx(z6,{isActive:f,setIsActive:p})]}),c.jsx(A0,{style:{marginTop:"12px"}}),c.jsx(F0,{style:{paddingLeft:"12px",marginTop:"12px"},children:"Участники"}),c.jsx(Q6,{style:{marginTop:"12px"},children:a.members.map(S=>c.jsxs(K6,{children:[c.jsx(X6,{children:c.jsx(J6,{children:S.photo&&c.jsx("img",{src:`${X}/${S.photo}`})})}),c.jsx(Z6,{children:`${S.first_name} ${S.second_name}`})]}))}),c.jsxs(e5,{style:{marginTop:"24px",marginBottom:"12px"},children:[c.jsx(Je,{style:{flex:1},onClick:()=>{x(),r(!1)},children:"Покинуть чат"}),a.owner.id===u.id&&c.jsx(ps,{style:{color:"#EC545D",flex:1},onClick:()=>{y(),r(!1)},children:"Удалить чат"})]})]})},n5=h.div`
      flex: 1;
      display: flex;
      flex-direction: column;
      overflow: visible;
