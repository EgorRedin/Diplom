...
`,eE=g.div`
      ...
      letter-spacing: -0.01em;
      color: #ff6a55;
`,tE=({loginWrapperStyles:e,passwordWrapperStyles:t})=>{const n=Ze(),[r,i]=b.useState(!1),[s,o]=b.useState(!1),[a,l]=b.useState({}),[u,d]=b.useState(!0),[f,p]=b.useState(!0),[m,x]=b.useState({email:"",password:""}),[h,S]=b.useState(!1),[v,y]=b.useState(!1),[w,k]=b.useState(new Array(4).fill("")),_=L=>{L.target.validity.valid&&L.target.value!==""?(i(!0),l({color:"#1a1d1f",background:"#f4f4f4"}),O(L),d(!1)):L.target.value!==""?(i(!1),l({color:"#ff6a55",background:"rgba(255, 188, 153, 0.25)"}),O(L),d(!1)):L.target.value===""&&(l({color:"#1a1d1f",background:"#f4f4f4"}),O(L),d(!0))},E=L=>{L.target.value.length>0?(O(L),o(!0)):(O(L),o(!1))},D=b.useCallback(()=>{const L=m.email,Z=m.password;p(!(L&&Z&&r&&s))},[m,r,s]),O=L=>{const Z=L.target.name,Oe=L.target.value;x(q=>({...q,[Z]:Oe}))},K=L=>{L.preventDefault(),BC(m.email,m.password).then(Z=>{(Z==null?void 0:Z.status)===200&&S(!0),(Z==null?void 0:Z.status)===403&&S(!0)}).catch(Z=>{console.log(Z.message)})},N=()=>{const L=w.join("");console.log(L),UC(m.email,L).then(Z=>{if(console.log(Z),(Z==null?void 0:Z.status)===200){y(!1),n("/login");return}(Z==null?void 0:Z.status)!==200&&y(!0)})};return b.useEffect(()=>{D()},[m,D]),c.jsx("form",{onSubmit:K,children:c.jsxs(YC,{children:[c.jsx(qC,{children:"Регистрация"}),!h&&c.jsxs(c.Fragment,{children:[c.jsx(VC,{}),c.jsx(Tm,{children:"Or continue with email address"}),c.jsxs(GC,{style:e,children:[c.jsx(KC,{src:"public/icons/mail.svg"}),r&&!u&&c.jsx(JC,{src:"public/icons/check-input.svg"}),!r&&!u&&c.jsx(ZC,{src:"public/icons/warning.svg"}),c.jsx(Rm,{placeholder:"Ваш email",type:"email",name:"email",value:m.email||"",style:a,onChange:L=>{_(L)}})]}),c.jsxs(QC,{style:t,children:[c.jsx(XC,{src:"public/icons/lock.svg"}),c.jsx(Rm,{placeholder:"Пароль",type:"password",name:"password",value:m.password||"",onChange:L=>{E(L)}})]}),c.jsx(Je,{style:{width:"100%",marginTop:"12px"},disabled:f,type:"submit",children:"Продолжить"})]}),h&&c.jsxs(c.Fragment,{children:[c.jsx(Tm,{children:"Мы выслали вам код подтверждения. Проверьте свой почтовый ящик."}),c.jsx(gD,{otp:w,setOtp:k,style:{marginTop:"32px"}}),v&&c.jsx(eE,{style:{marginTop:"12px"},children:"Неверный код подтверждения."}),c.jsx(Je,{style:{width:"260px",marginTop:"12px"},type:"button",onClick:()=>{N()},children:"Продолжить"})]})]})})},nE=g.div`
      display: flex;
      flex-direction: row;
      width: 100vw;
      height: 100vh;
...
`,vE=({loginWrapperStyles:e,passwordWrapperStyles:t})=>{const{setIsAuth:n}=b.useContext(Ko),r=Ze(),[i,s]=b.useState(!1),[o,a]=b.useState(!1),[l,u]=b.useState({}),[d,f]=b.useState(!0),[p,m]=b.useState(!0),[x,h]=b.useState({email:"",password:""}),S=_=>{_.target.validity.valid&&_.target.value!==""?(s(!0),u({color:"#1a1d1f",background:"#f4f4f4"}),w(_),f(!1)):_.target.value!==""?(s(!1),u({color:"#ff6a55",background:"rgba(255, 188, 153, 0.25)"}),w(_),f(!1)):_.target.value===""&&(u({color:"#1a1d1f",background:"#f4f4f4"}),w(_),f(!0))},v=_=>{_.target.value.length>0?(w(_),a(!0)):(w(_),a(!1))},y=b.useCallback(()=>{const _=x.email,E=x.password;m(!(_&&E&&i&&o))},[x,i,o]),w=_=>{const E=_.target.name,D=_.target.value;h(O=>({...O,[E]:D}))},k=_=>{_.preventDefault(),HC(x.email,x.password).then(E=>{if(E.status===200){const D=E.data.access_token;window.localStorage.setItem("access_token",D),n(!0),r("/home")}}).catch(E=>{console.log(E)})};return b.useEffect(()=>{y()},[x,y]),c.jsxs("form",{onSubmit:k,children:[c.jsxs(pE,{style:e,children:[c.jsx(gE,{src:"public/icons/mail.svg"}),i&&!d&&c.jsx(yE,{src:"public/icons/check-input.svg"}),!i&&!d&&c.jsx(xE,{src:"public/icons/warning.svg"}),c.jsx(Mm,{placeholder:"Ваш email",type:"email",name:"email",value:x.email||"",style:l,onChange:_=>{S(_)}})]}),c.jsxs(hE,{style:t,children:[c.jsx(mE,{src:"public/icons/lock.svg"}),c.jsx(Mm,{placeholder:"Пароль",type:"password",name:"password",value:x.password||"",onChange:_=>{v(_)}})]}),c.jsx(Je,{style:{width:"100%",marginTop:"12px"},disabled:p,type:"submit",children:"Вход"})]})},wE=g.div`
      display: flex;
      flex-direction: row;
      justify-content: center;
      align-items: center;
...
`,EE=()=>{const e=Ze();return c.jsx(wE,{children:c.jsxs(kE,{children:[c.jsx(SE,{src:"/public/logo.svg"}),c.jsx(bE,{children:"Вход"}),c.jsx(_E,{}),c.jsx(DE,{children:"Для входа введите email"}),c.jsx(vE,{loginWrapperStyles:{marginTop:"20px"},passwordWrapperStyles:{marginTop:"12px"}}),c.jsxs(CE,{children:["Еще нет аккаунта?"," ",c.jsx("a",{onClick:()=>{e("/register")},children:c.jsx("span",{children:"Регистрация"})})]})]})})},Nm=g.button`
      display: flex;
      /* align-items: center; */
      width: 292px;
      height: 48px;
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Xo=b;function jE(e,t){return e===t&&(e!==0||1/e===1/t)||e!==e&&t!==t}var OE=typeof Object.is=="function"?Object.is:jE,PE=Xo.useSyncExternalStore,TE=Xo.useRef,RE=Xo.useEffect,ME=Xo.useMemo,NE=Xo.useDebugValue;y1.useSyncExternalStoreWithSelector=function(e,t,n,r,i){var s=TE(null);if(s.current===null){var o={hasValue:!1,value:null};s.current=o}else o=s.current;s=ME(function(){function l(m){if(!u){if(u=!0,d=m,m=r(m),i!==void 0&&o.hasValue){var x=o.value;if(i(x,m))return f=x}return f=m}if(x=f,OE(d,m))return x;var h=r(m);return i!==void 0&&i(x,h)?x:(d=m,f=h)}var u=!1,d,f,p=n===void 0?null:n;return[function(){return l(t())},p===null?void 0:function(){return l(p())}]},[t,n,r,i]);var a=PE(e,s[0],s[1]);return RE(function(){o.hasValue=!0,o.value=a},[a]),NE(a),a};m1.exports=y1;var $E=m1.exports,At="default"in ad?$t:ad,Fm=Symbol.for("react-redux-context"),Lm=typeof globalThis<"u"?globalThis:{};function IE(){if(!At.createContext)return{};const e=Lm[Fm]??(Lm[Fm]=new Map);let t=e.get(At.createContext);return t||(t=At.createContext(null),e.set(At.createContext,t)),t}var Er=IE(),AE=()=>{throw new Error("uSES not initialized!")};function Gp(e=Er){return function(){return At.useContext(e)}}var x1=Gp(),v1=AE,FE=e=>{v1=e},LE=(e,t)=>e===t;function zE(e=Er){const t=e===Er?x1:Gp(e),n=(r,i={})=>{const{equalityFn:s=LE,devModeChecks:o={}}=typeof i=="function"?{equalityFn:i}:i,{store:a,subscription:l,getServerState:u,stabilityCheck:d,identityFunctionCheck:f}=t();At.useRef(!0);const p=At.useCallback({[r.name](x){return r(x)}}[r.name],[r,d,o.stabilityCheck]),m=v1(l.addNestedSub,a.getState,u||a.getState,p,s);return At.useDebugValue(m),m};return Object.assign(n,{withTypes:()=>n}),n}var WE=zE();function BE(e){e()}function UE(){let e=null,t=null;return{clear(){e=null,t=null},notify(){BE(()=>{let n=e;for(;n;)n.callback(),n=n.next})},get(){const n=[];let r=e;for(;r;)n.push(r),r=r.next;return n},subscribe(n){let r=!0;const i=t={callback:n,next:null,prev:t};return i.prev?i.prev.next=i:e=i,function(){!r||e===null||(r=!1,i.next?i.next.prev=i.prev:t=i.prev,i.prev?i.prev.next=i.next:e=i.next)}}}}var zm={notify(){},get:()=>[]};function HE(e,t){let n,r=zm,i=0,s=!1;function o(h){d();const S=r.subscribe(h);let v=!1;return()=>{v||(v=!0,S(),f())}}function a(){r.notify()}function l(){x.onStateChange&&x.onStateChange()}function u(){return s}function d(){i++,n||(n=e.subscribe(l),r=UE())}function f(){i--,n&&i===0&&(n(),n=void 0,r.clear(),r=zm)}function p(){s||(s=!0,d())}function m(){s&&(s=!1,f())}const x={addNestedSub:o,notifyNestedSubs:a,handleChangeWrapper:l,isSubscribed:u,trySubscribe:p,tryUnsubscribe:m,getListeners:()=>r};return x}var YE=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u",qE=typeof navigator<"u"&&navigator.product==="ReactNative",VE=YE||qE?At.useLayoutEffect:At.useEffect;function GE({store:e,context:t,children:n,serverState:r,stabilityCheck:i="once",identityFunctionCheck:s="once"}){const o=At.useMemo(()=>{const u=HE(e);return{store:e,subscription:u,getServerState:r?()=>r:void 0,stabilityCheck:i,identityFunctionCheck:s}},[e,r,i,s]),a=At.useMemo(()=>e.getState(),[e]);VE(()=>{const{subscription:u}=o;return u.onStateChange=u.notifyNestedSubs,u.trySubscribe(),a!==e.getState()&&u.notifyNestedSubs(),()=>{u.tryUnsubscribe(),u.onStateChange=void 0}},[o,a]);const l=t||Er;return At.createElement(l.Provider,{value:o},n)}var QE=GE;function w1(e=Er){const t=e===Er?x1:Gp(e),n=()=>{const{store:r}=t();return r};return Object.assign(n,{withTypes:()=>n}),n}var KE=w1();function XE(e=Er){const t=e===Er?KE:w1(e),n=()=>t().dispatch;return Object.assign(n,{withTypes:()=>n}),n}var vt=XE();FE($E.useSyncExternalStoreWithSelector);const we=WE,JE=g.div`
      width: 340px;
      height: 100%;
      background: #fcfcfc;
      padding: 24px;
...
`,Jo=({style:e})=>c.jsxs(nj,{style:e,children:[c.jsx(rj,{src:"/public/icons/search.svg"}),c.jsx(ij,{placeholder:"Поиск"})]}),sj=g.div`
      width: 48px;
      height: 48px;
      position: relative;
      display: flex;
...
`,Wm=({isActive:e,iconPathInactive:t,iconPathActive:n,onClick:r})=>c.jsx(sj,{onClick:r,children:e?c.jsxs(c.Fragment,{children:[c.jsx("img",{src:n}),c.jsx(oj,{})]}):c.jsx("img",{src:t})}),aj=g.div`
      width: 56px;
      height: 56px;
      position: relative;
`,lj=g.div`
...
`,uj=g.div`
      ...
      top: -2px;
      left: -2px;
`,jr=({isOnline:e,src:t,...n})=>c.jsx(aj,{children:c.jsxs(lj,{...n,children:[e&&c.jsx(uj,{}),t?c.jsx(cj,{src:t}):c.jsx(c.Fragment,{})]})}),pn=g.div`
      width: 16px;
      height: 32px;
      border-radius: 4px;
      background: #2a85ff;
...
`,fj=g.img`
      width: 20px;
      height: 20px;
`,S1=({onClick:e})=>c.jsx(dj,{onClick:e,children:c.jsx(fj,{src:"/public/icons/close_dark_20.svg"})}),Qp=g.button`
      padding: 0;
      margin: 0;
      outline: none;
      border: none;
...
`,gj=g.div`
      ...
      color: #33383f;
`,b1=({avatarPath:e,name:t,...n})=>{const[r,i]=b.useState(!1);return c.jsxs(pj,{...n,onMouseOver:()=>{i(!0)},onMouseOut:()=>{i(!1)},children:[!r&&(e?c.jsx(Bm,{children:c.jsx("img",{src:e})}):c.jsx(Bm,{})),r&&c.jsx(hj,{children:c.jsx("img",{src:"/public/icons/close_light.svg"})}),c.jsx(gj,{children:t})]})},Ac=g.input`
      width: 100%;
      height: 48px;
...
`,AN=g.div`
      ...
      gap: 8px;
      margin-top: 32px;
`,Zw=({date:e,setDate:t,close:n,startStringDate:r,setStartStringDate:i,endStringDate:s,setEndStringDate:o})=>{b.useEffect(()=>{e.startDate&&i(a(e.startDate)),e.endDate&&o(a(e.endDate))},[e,i,o]);const a=f=>{const p=f.getDate(),m=f.getMonth(),x=NN[m];return p+" "+x},l=f=>{t(f.selection)},u=f=>{f.preventDefault(),t({startDate:new Date,endDate:new Date,key:"selection"})},d=()=>{n()};return c.jsxs($N,{children:[c.jsx(k1.DateRange,{locale:tc,ranges:[e],onChange:l,color:"#2A85FF",showMonthAndYearPickers:!1}),c.jsx(IN,{}),c.jsx(r0,{placeholder:"Дата начала",value:r,style:{marginTop:"24px"},disabled:!0}),c.jsx(r0,{placeholder:"Дата окончания",value:s,style:{marginTop:"16px"},disabled:!0}),c.jsxs(AN,{children:[c.jsx(ps,{style:{padding:"8px 16px 8px 16px",fontSize:"13px",height:"40px"},onClick:u,children:"Очистить"}),c.jsx(Je,{style:{padding:"8px 16px 8px 16px",height:"40px",fontSize:"13px"},onClick:d,children:"Сохранить"})]})]})},FN=g.div`
      padding: 16px;
      width: 280px;
      height: 272px;
      display: flex;
...
`,LN=g.div`
      width: 100%;
      overflow: auto;
`,eS=({setIsQueryDropdown:e,...t})=>{const n=b.useRef(null);return b.useEffect(()=>{const r=({target:i})=>{var s;(s=n.current)!=null&&s.contains(i)||e(!1)};return document.addEventListener("mousedown",r),()=>{document.removeEventListener("mousedown",r)}},[e]),c.jsxs(FN,{...t,ref:n,children:[c.jsx(Jo,{}),c.jsx(LN,{children:t.children})]})},zN=g.div`
      display: flex;
      flex-direction: row;
      justify-content: flex-start;
      align-items: center;
...
`,l3=g.div`
      ...
      gap: 8px;
      margin-top: 32px;
`,c3=({close:e})=>{const t=vt(),n=xn.actions.setProjects,[r,i]=b.useState(),s=we(N=>N.userReducer.user),[o,a]=b.useState(!1),[l,u]=b.useState(""),[d,f]=b.useState(""),[p,m]=b.useState({startDate:new Date,endDate:new Date,key:"selection"}),[x,h]=b.useState(""),[S,v]=b.useState(""),[y,w]=b.useState(!0),[k,_]=b.useState(!1),[E,D]=b.useState([]);b.useEffect(()=>{r&&p.startDate&&p.endDate&&l&&l.length>0&&d&&d.length>0&&x.length>0&&S.length>0?w(!1):w(!0)},[r,p.startDate,p.endDate,S.length,x.length,l,d]);const O=b.useRef(null);b.useEffect(()=>{const N=({target:L})=>{var Z;(Z=O.current)!=null&&Z.contains(L)||a(!1)};return document.addEventListener("mousedown",N),()=>{document.removeEventListener("mousedown",N)}},[a]);const K=N=>{var q,ce;N.preventDefault();const L=window.localStorage.getItem("access_token"),Z=E.map(Se=>Se.id),Oe={name:l,description:d,time_start:(q=p.startDate)==null?void 0:q.toISOString(),time_end:(ce=p.endDate)==null?void 0:ce.toISOString(),assigned:[s.id,...Z]};L&&r&&YN(L,r==null?void 0:r.id,Oe).then(Se=>{Se.status===200&&mn(L).then($e=>{t(n($e.data.projects))}).catch()}).catch(),e()};return c.jsxs(Z$,{children:[c.jsx(e3,{}),c.jsxs(t3,{children:[c.jsxs(n3,{children:[c.jsxs(r3,{children:[c.jsx(pn,{style:{marginRight:"16px"}}),c.jsx(i3,{children:"Новая задача"})]}),c.jsx(S1,{onClick:e})]}),c.jsxs("form",{onSubmit:K,children:[c.jsxs(s3,{children:[c.jsx("img",{src:"/public/icons/person_gray.svg",style:{width:"24px",height:"24px"}}),E.map(N=>c.jsx(b1,{type:"button",avatarPath:N.photo?`${J}/${N.photo}`:void 0,name:`${N.first_name} ${N.second_name}`,onClick:()=>{D(E.filter(L=>L.id!==N.id))}})),c.jsxs(Ki,{style:{position:"relative"},onClick:N=>{N.preventDefault(),_(!0)},children:[c.jsx("img",{src:"/public/icons/plus_gray_20.svg"}),k&&c.jsx(eS,{setIsQueryDropdown:_,style:{position:"absolute",top:"0",left:"0",zIndex:1e4},children:r==null?void 0:r.members.filter(N=>N.id!==s.id).map(N=>E.includes(N)?c.jsx(c.Fragment,{}):c.jsx(tS,{avatarUrl:N.photo?`${J}/${N.photo}`:void 0,name:N.first_name+" "+N.second_name,onClick:()=>{D([N,...E])}}))})]})]}),c.jsxs(o3,{children:[c.jsx("img",{src:"/public/icons/schedule_light_24.svg",style:{width:"24px",height:"24px"}}),!x&&!S&&c.jsx(Ki,{onClick:N=>{N.preventDefault(),a(!o)},children:c.jsx("img",{src:"/public/icons/plus_gray_20.svg"})}),x&&S&&c.jsx(Ki,{style:{width:"fit-content",padding:"4px 8px 4px 8px",color:"#33383F"},onClick:N=>{N.preventDefault(),a(!o)},children:x+" - "+S}),o&&c.jsx(a3,{ref:O,children:c.jsx(Zw,{date:p,setDate:m,close:()=>{a(!1)},startStringDate:x,endStringDate:S,setStartStringDate:h,setEndStringDate:v})})]}),c.jsx(an,{style:{marginTop:"24px"},children:"Задача"}),c.jsx(Ac,{style:{marginTop:"12px"},value:l,onChange:N=>u(N.target.value)}),c.jsx(an,{style:{marginBottom:"12px",marginTop:"24px"},children:"Проект"}),c.jsx(yS,{setValue:i,value:r}),c.jsx(an,{style:{marginTop:"24px"},children:"Описание"}),c.jsx(mj,{style:{marginTop:"12px"},value:d,onChange:N=>f(N.target.value)}),c.jsxs(l3,{children:[c.jsx(ps,{style:{padding:"12px 68px 12px 68px"},onClick:e,children:"Отмена"}),c.jsx(Je,{type:"submit",style:{padding:"12px 68px 12px 68px"},disabled:y,children:"Создать"})]})]})]})]})},u3=g.div`
      display: flex;
      flex-direction: column;
      gap: 12px;
      position: absolute;
...
`,w3=g.div`
      flex: 1;
      overflow: hidden;
`,S3=()=>c.jsxs(x3,{children:[c.jsx(tj,{}),c.jsxs(v3,{children:[c.jsx(y3,{}),c.jsx(w3,{children:c.jsx(a2,{})})]})]}),b3=g.div`
      width: 324px;
      height: 224px;
      padding: 24px;
      position: relative;
...
`,_3=g.img`
      ...
      width: 112px;
      height: 112px;
`,Ei=({title:e,buttonTitle:t,isDisabled:n,onClick:r,imgPath:i})=>c.jsxs(b3,{children:[c.jsx(k3,{children:e}),c.jsx(Je,{onClick:r,disabled:n,children:t}),c.jsx(_3,{src:i})]}),D3=g.div`
      width: 100%;
      height: 100%;
...
`,h0=({direction:e,disabled:t,...n})=>{switch(e){case"backward":return c.jsx(O3,{disabled:t,...n,children:c.jsx("img",{})});case"forward":return c.jsx(P3,{disabled:t,...n,children:c.jsx("img",{})})}},T3=g.div`
      height: 108px;
      width: 100%;
      border-radius: 8px;
      padding: 8px;
...
`,L3=({week:e})=>{const t=Ze(),n=_n(e),r=we(l=>l.projectsReducer.projects),[i,s]=b.useState([]),o=(l,u)=>{const d=l.filter(f=>new Date(f.time_start).getDate()===u.getDate());return console.log(d),d},a=()=>{const l=[];r.map(u=>{u.tasks.map(d=>{l.push(d)})}),s(l)};return b.useEffect(()=>{a()},[r]),c.jsxs(F3,{children:[c.jsxs(Yr,{children:[c.jsx(Hr,{children:n[0][0]}),o(i,e[0]).map(l=>{var u,d;return c.jsx(Ur,{projectTitle:(u=r.find(f=>f.tasks.includes(l)))==null?void 0:u.name,colour:(d=r.find(f=>f.tasks.includes(l)))==null?void 0:d.color,taskTitle:l.name,date:_n([new Date(l.time_start)])[0][1],onClick:()=>t(`/tasks/${l.id}`)})})]}),c.jsxs(Yr,{children:[c.jsx(Hr,{children:n[1][0]}),o(i,e[1]).map(l=>{var u,d;return c.jsx(Ur,{projectTitle:(u=r.find(f=>f.tasks.includes(l)))==null?void 0:u.name,colour:(d=r.find(f=>f.tasks.includes(l)))==null?void 0:d.color,taskTitle:l.name,date:_n([new Date(l.time_start)])[0][1],onClick:()=>t(`/tasks/${l.id}`)})})]}),c.jsxs(Yr,{children:[c.jsx(Hr,{children:n[2][0]}),o(i,e[2]).map(l=>{var u,d;return c.jsx(Ur,{projectTitle:(u=r.find(f=>f.tasks.includes(l)))==null?void 0:u.name,colour:(d=r.find(f=>f.tasks.includes(l)))==null?void 0:d.color,taskTitle:l.name,date:_n([new Date(l.time_start)])[0][1],onClick:()=>t(`/tasks/${l.id}`)})})]}),c.jsxs(Yr,{children:[c.jsx(Hr,{children:n[3][0]}),o(i,e[3]).map(l=>{var u,d;return c.jsx(Ur,{projectTitle:(u=r.find(f=>f.tasks.includes(l)))==null?void 0:u.name,colour:(d=r.find(f=>f.tasks.includes(l)))==null?void 0:d.color,taskTitle:l.name,date:_n([new Date(l.time_start)])[0][1],onClick:()=>t(`/tasks/${l.id}`)})})]}),c.jsxs(Yr,{children:[c.jsx(Hr,{children:n[4][0]}),o(i,e[4]).map(l=>{var u,d;return c.jsx(Ur,{projectTitle:(u=r.find(f=>f.tasks.includes(l)))==null?void 0:u.name,colour:(d=r.find(f=>f.tasks.includes(l)))==null?void 0:d.color,taskTitle:l.name,date:_n([new Date(l.time_start)])[0][1],onClick:()=>t(`/tasks/${l.id}`)})})]}),c.jsxs(Yr,{children:[c.jsx(Hr,{children:n[5][0]}),o(i,e[5]).map(l=>{var u,d;return c.jsx(Ur,{projectTitle:(u=r.find(f=>f.tasks.includes(l)))==null?void 0:u.name,colour:(d=r.find(f=>f.tasks.includes(l)))==null?void 0:d.color,taskTitle:l.name,date:_n([new Date(l.time_start)])[0][1],onClick:()=>t(`/tasks/${l.id}`)})})]}),c.jsxs(Yr,{children:[c.jsx(Hr,{children:n[6][0]}),o(i,e[6]).map(l=>{var u,d;return c.jsx(Ur,{projectTitle:(u=r.find(f=>f.tasks.includes(l)))==null?void 0:u.name,colour:(d=r.find(f=>f.tasks.includes(l)))==null?void 0:d.color,taskTitle:l.name,date:_n([new Date(l.time_start)])[0][1],onClick:()=>t(`/tasks/${l.id}`)})})]})]})},z3=g.div`
      padding: 24px;
      display: flex;
      flex-direction: row;
      justify-content: flex-start;
...
`,W3=g.div`
      ...
      color: #1a1d1f;
      flex: 1;
`,B3=()=>{const[e,t]=b.useState(0),[n,r]=b.useState(g0(e)),i=()=>{const s=g0(e);r(s)};return b.useEffect(()=>{i()},[e]),c.jsxs(c.Fragment,{children:[c.jsxs(z3,{children:[c.jsx(pn,{style:{marginRight:"16px"}}),c.jsx(W3,{children:"Задачи"}),c.jsx(h0,{direction:"backward",disabled:!1,onClick:()=>{t(e-1)}}),c.jsx(h0,{direction:"forward",disabled:!1,onClick:()=>{t(e+1)}})]}),c.jsx(L3,{week:n})]})},y0=g.div`
      background: #efefef;
      padding: 4px 8px 4px 8px;
      border-radius: 41px;
      font-size: 15px;
      ...
      color: #6f767e;
      width: fit-content;
`,po=({color:e,bgColor:t,isActive:n=!0,...r})=>n?c.jsx(y0,{style:{color:e,backgroundColor:t},...r}):c.jsx(y0,{...r}),x0=g.div`
      height: 32px;
      position: relative;
      display: flex;
      align-items: center;
...
`,U3=({name:e,avatarPath:t})=>t?c.jsxs(x0,{children:[c.jsx(w0,{children:c.jsx("img",{src:t})}),c.jsx(v0,{children:e})]}):c.jsxs(x0,{children:[c.jsx(w0,{style:{background:"rgb(177, 229, 252)"}}),c.jsx(v0,{children:e})]}),Ku=g.div`
      display: flex;
      flex-direction: row;
      justify-content: flex-start;
      align-items: center;
...
`,nI=g.div`
      ...
      white-space: nowrap;
      cursor: pointer;
`,wS=({section:e,sortBy:t})=>{const n=Ze(),r=vt(),i=xn.actions.setProjects,[s,o]=b.useState(NaN),a=we(m=>m.projectsReducer.projects),[l,u]=b.useState(),d=b.useCallback(()=>{const m=[];return a.map(x=>{x.tasks.map(h=>{m.push(h)})}),m},[a]),f=b.useCallback((m,x,h)=>{if(m){if(h==="По дате")return[...m].sort((v,y)=>new Date(y.time_start).getTime()-new Date(v.time_start).getTime());if(h==="По владельцу")return[...m].sort((v,y)=>{var _,E;const w=(_=x.find(D=>D.tasks.includes(v)))==null?void 0:_.owner,k=(E=x.find(D=>D.tasks.includes(y)))==null?void 0:E.owner;return w.id-k.id});if(h==="По статусу")return[...m].sort(function(v,y){return v.status>y.status?-1:v.status<y.status?1:0});if(h==="По названию")return[...m].sort(function(v,y){return v.name<y.name?-1:v.name>y.name?1:0})}else return m},[]),p=b.useCallback(()=>{var m;if(s){const x=(m=a.find(h=>h.id===s))==null?void 0:m.tasks;if(x){const h=f(x,a,t);u(h)}return}if(isNaN(s)){const x=d(),h=f(x,a,t);u(h)}},[s,a,d,f,t]);return b.useEffect(()=>{u(d())},[a,d]),b.useEffect(()=>{p()},[s,a,p]),b.useLayoutEffect(()=>{const m=window.localStorage.getItem("access_token");m&&mn(m).then(x=>{x.status===200&&r(i(x.data.projects))}).catch()},[r,i]),c.jsxs(Y3,{children:[e==="projects"&&c.jsxs(q3,{children:[c.jsx(po,{color:"#FCFCFC",bgColor:"#2A85FF",isActive:!s,onClick:()=>{o(NaN)},children:"Все проекты"}),a.map(m=>c.jsx(po,{color:"#33383F",bgColor:m.color,isActive:m.id===s,onClick:()=>{o(m.id)},children:m.name}))]}),e==="tasks"&&c.jsxs(V3,{children:[c.jsx(pn,{style:{marginRight:"16px"}}),c.jsx(G3,{children:"Задачи"})]}),c.jsx(Q3,{children:c.jsxs(K3,{children:[c.jsx(X3,{children:c.jsxs(J3,{children:[c.jsx(Ys,{children:"Дата начала"}),c.jsx(Ys,{children:"Проект"}),c.jsx(Ys,{children:"Название задачи"}),c.jsx(Ys,{children:"Владелец"}),c.jsx(Ys,{children:"Статус задачи"})]})}),c.jsx(Z3,{children:l==null?void 0:l.map(m=>{var x,h,S,v,y,w;return c.jsxs(eI,{children:[c.jsx(qs,{children:c.jsx(tI,{children:_n([new Date(m.time_start)])[0][1]})}),c.jsx(qs,{children:c.jsx(po,{color:"#33383F",bgColor:(x=a.find(k=>k.tasks.includes(m)))==null?void 0:x.color,children:(h=a.find(k=>k.tasks.includes(m)))==null?void 0:h.name})}),c.jsx(qs,{children:c.jsx(nI,{onClick:()=>{n(`/tasks/${m.id}`)},children:m.name})}),c.jsx(qs,{children:c.jsx(U3,{name:((S=a.find(k=>k.tasks.includes(m)))==null?void 0:S.owner.first_name)+" "+((v=a.find(k=>k.tasks.includes(m)))==null?void 0:v.owner.second_name),avatarPath:(y=a.find(k=>k.tasks.includes(m)))!=null&&y.owner.photo?J+"/"+((w=a.find(k=>k.tasks.includes(m)))==null?void 0:w.owner.photo):void 0})}),c.jsx(qs,{children:c.jsx(H3,{type:m.status})})]})})})]})})]})},rI=g.div`
      height: 224px;
      border-radius: 12px;
      background: #f4f4f4;
      padding: 24px;
...
`,cI=g.div`
      ...
      letter-spacing: -0.01em;
      color: #272b30;
`,Zu=({task:e,project:t,onClick:n})=>c.jsxs(rI,{onClick:n,children:[c.jsx(iI,{style:{background:t.color},children:t.name}),c.jsx(sI,{children:e.name}),c.jsx(oI,{children:e.description}),c.jsxs(aI,{children:[c.jsx(lI,{src:"/public/icons/calendar_gray_20.svg"}),c.jsx(cI,{children:_n([new Date(e.time_start)])[0][1]})]})]}),uI=g.div`
      flex: 1;
      display: flex;
      flex-direction: row;
      justify-content: space-between;
...
`,NI=g.div`
      ...
      gap: 8px;
      margin-top: 32px;
`,$I=({close:e})=>{const t=vt(),n=xn.actions.setProjects,r=["#FFBC99","#CABDFF","#B1E5FC","#B5E4CA","#FFD88D"],[i,s]=b.useState(""),[o,a]=b.useState("#FFBC99"),[l,u]=b.useState(!0),d=b.useCallback(()=>{i.length>0?u(!1):u(!0)},[i]),f=p=>{p.preventDefault();const m=window.localStorage.getItem("access_token");m&&UN(m,i,o).then(x=>{x.status===200&&mn(m).then(h=>{t(n(h.data.projects))}).catch(h=>{console.log(h)})}).catch(x=>console.log(x)),e()};return b.useEffect(()=>{d()},[i,d]),c.jsxs(bI,{children:[c.jsx(kI,{}),c.jsxs(_I,{children:[c.jsxs(DI,{children:[c.jsxs(CI,{children:[c.jsx(pn,{style:{marginRight:"16px"}}),c.jsx(EI,{children:"Новый проект"})]}),c.jsx(S1,{onClick:e})]}),c.jsxs("form",{onSubmit:f,children:[c.jsx(jI,{children:"Название проекта"}),c.jsx(Ac,{style:{marginTop:"12px"},value:i,onChange:p=>s(p.target.value)}),c.jsx(OI,{children:"Цвет проекта"}),c.jsx(PI,{children:r.map(p=>c.jsxs(TI,{children:[c.jsx(RI,{style:{backgroundColor:p},type:"radio",value:p,checked:o===p,onChange:m=>a(m.target.value)}),p===o&&c.jsx(MI,{src:"/public/icons/check_dark_24.svg"})]},p))}),c.jsxs(NI,{children:[c.jsx(ps,{style:{padding:"12px 68px 12px 68px"},onClick:e,children:"Отмена"}),c.jsx(Je,{disabled:l,type:"submit",style:{padding:"12px 68px 12px 68px"},children:"Создать"})]})]})]})]})},II=g.div`
      background: #f4f4f4;
...
`,GI=g.div`
      ...
      letter-spacing: -0.015em;
      color: #33383f;
`,QI=({avatarPath:e,name:t,...n})=>c.jsxs(qI,{...n,children:[c.jsx(VI,{children:e&&c.jsx("img",{src:e})}),c.jsx(GI,{children:t})]}),KI=async(e,t,n)=>await re.post(`${J}/comment/${t}`,{content:n},{headers:{Authorization:`Bearer ${e}`},validateStatus:function(i){return i<500}}),XI=async(e,t)=>await re.delete(`${J}/comment/${t}`,{headers:{Authorization:`Bearer ${e}`},validateStatus:function(r){return r<500}}),JI=g.div`
      min-height: 116px;
      padding: 12px;
      display: flex;
      flex-direction: row;
...
`,dA=["Января","Февраля","Марта","Апреля","Мая","Июня","Июля","Августа","Сентября","Октября","Ноября","Декабря"],fA=g.div`
      width: 100%;
      height: 100%;
...
`,jA=g.div`
      ...
      align-items: center;
      gap: 12px;
`,OA=()=>{const e=vt(),t=xn.actions.setProjects,n=we(h=>h.userReducer.user),r=we(h=>h.projectsReducer.projects),i=h=>{const S=h.getDate(),v=h.getMonth(),y=dA[v];return S+" "+y},s=[{value:"todo",title:"К исполнению",colorHex:"#2A85FF"},{value:"inprogress",title:"В процессе",colorHex:"#8E59FF"},{value:"completed",title:"Выполненно",colorHex:"#83BF6E"}],[o,a]=b.useState("todo"),l=xv(),u=Ze(),d=Number(l.id),[f,p]=b.useState(),[m,x]=b.useState();return b.useEffect(()=>{const h=window.localStorage.getItem("access_token");h&&m&&f&&jf(h,m==null?void 0:m.id,f==null?void 0:f.id,{status:o}).then(()=>{mn(h).then(S=>{e(t(S.data.projects))}).catch()}).catch()},[o]),b.useEffect(()=>{const h=r.find(v=>v.tasks.find(y=>y.id===d));x(h);const S=h==null?void 0:h.tasks.find(v=>v.id===d);p(S)},[r]),b.useEffect(()=>{f&&a(f==null?void 0:f.status)},[f]),c.jsxs(fA,{children:[c.jsx(pA,{children:"Информация о задаче"}),c.jsxs(hA,{children:[c.jsxs(gA,{children:[c.jsx("div",{style:{display:"flex",alignItems:"center",flex:1},children:c.jsx(bS,{onClick:()=>u("/tasks"),children:c.jsx("img",{src:"/public/icons/arrow_backward_light_24.svg"})})}),c.jsx(mA,{onClick:()=>{u("settings")},children:c.jsx("img",{src:"/public/icons/settings_light_24.svg"})}),c.jsx(SS,{value:o,setValue:a,options:s})]}),c.jsxs(yA,{children:[c.jsx(xA,{children:f==null?void 0:f.name}),c.jsx(vA,{children:f==null?void 0:f.description}),c.jsxs(wA,{children:[c.jsx("img",{src:"/public/icons/person_gray.svg"}),f==null?void 0:f.assigned.map(h=>c.jsx(QI,{avatarPath:h.photo?`${J}/${h.photo}`:void 0,name:`${h.first_name} ${h.second_name}`}))]}),c.jsxs(SA,{children:[c.jsx("img",{src:"/public/icons/schedule_light_24.svg"}),c.jsx(bA,{children:f&&`${i(new Date(f==null?void 0:f.time_start))} - ${i(new Date(f==null?void 0:f.time_end))}`})]}),c.jsxs(kA,{children:[c.jsx("img",{src:"/public/icons/piechart_gray_24.svg"}),c.jsx(po,{color:"#33383F",bgColor:m==null?void 0:m.color,children:m&&m.name})]})]}),c.jsx(_A,{style:{marginTop:"24px"}}),c.jsxs(DA,{children:[c.jsx(CA,{children:"Комментарии"}),c.jsx(pn,{style:{background:"#CABDFF"}})]}),c.jsx(EA,{children:f&&f.comments.map(h=>c.jsx(aA,{comment:h,isCurrUser:h.sender.id===n.id}))}),c.jsx(jA,{children:c.jsx(uA,{taskId:f==null?void 0:f.id})})]})]})},PA=g.button`
      display: flex;
      flex-direction: row;
      justify-content: center;
      align-items: center;
...
`,TA=e=>c.jsx(PA,{...e}),RA=[{value:"todo",title:"К исполнению",colorHex:"#2A85FF"},{value:"inprogress",title:"В процессе",colorHex:"#8E59FF"},{value:"completed",title:"Выполненно",colorHex:"#83BF6E"}],MA=g.div`
      width: 100%;
      height: 100%;
      padding: 40px 40px 32px 40px;
      background: #f4f4f4;
...
`,WA=g.div`
      ...
      gap: 8px;
      margin-top: 32px;
`,BA=()=>{const e=vt(),t=xn.actions.setProjects,n=Ze(),r=xv(),i=Number(r.id),s=we(T=>T.projectsReducer.projects),o=we(T=>T.userReducer.user),[a,l]=b.useState("todo"),[u,d]=b.useState(),[f,p]=b.useState(),[m,x]=b.useState(""),[h,S]=b.useState(!1),[v,y]=b.useState(!1),[w,k]=b.useState(""),[_,E]=b.useState(""),[D,O]=b.useState(""),[K,N]=b.useState(!0),[L,Z]=b.useState({startDate:new Date,endDate:new Date,key:"selection"}),[Oe,q]=b.useState([]);b.useEffect(()=>{const T=window.localStorage.getItem("access_token");T&&f&&u&&jf(T,f==null?void 0:f.id,u==null?void 0:u.id,{status:a}).then(()=>{mn(T).then(z=>{e(t(z.data.projects))}).catch()}).catch()},[a]),b.useEffect(()=>{const T=s.find(Y=>Y.tasks.find(oe=>oe.id===i));p(T);const z=T==null?void 0:T.tasks.find(Y=>Y.id===i);d(z)},[s]),b.useEffect(()=>{u&&(l(u==null?void 0:u.status),x(u==null?void 0:u.name),k(u==null?void 0:u.description),Z({startDate:new Date(u.time_start),endDate:new Date(u.time_end),key:"selection"}),L.endDate&&O(m0(L.endDate)),L.startDate&&E(m0(L.startDate)),q(u.assigned))},[u]);const ce=b.useRef(null);b.useEffect(()=>{const T=({target:z})=>{var Y;(Y=ce.current)!=null&&Y.contains(z)||S(!1)};return document.addEventListener("mousedown",T),()=>{document.removeEventListener("mousedown",T)}},[S]),b.useEffect(()=>{L.startDate&&L.endDate&&m&&m.length>0&&w&&w.length>0&&_.length>0&&D.length>0?N(!1):N(!0)},[L.startDate,L.endDate,D.length,_.length,m,w]);const Se=()=>{const T=window.localStorage.getItem("access_token");T&&u&&f&&qN(T,f.id,u.id).then(z=>{z.status===200&&(mn(T).then(Y=>{e(t(Y.data.projects))}).catch(Y=>console.log(Y)),n("/tasks"))}).catch(z=>console.log(z))},$e=T=>{var ue,ft;T.preventDefault();const z=window.localStorage.getItem("access_token"),Y=Oe.map(M=>M.id),oe={name:m,description:w,time_start:(ue=L.startDate)==null?void 0:ue.toISOString(),time_end:(ft=L.endDate)==null?void 0:ft.toISOString(),assigned:[o.id,...Y]};z&&f&&u&&f&&jf(z,f.id,u==null?void 0:u.id,oe),close()};return c.jsxs(MA,{children:[c.jsx(NA,{children:"Редактирование задачи"}),c.jsxs($A,{children:[c.jsxs(IA,{children:[c.jsx(bS,{onClick:()=>n(`${J}/tasks/${u==null?void 0:u.id}`),children:c.jsx("img",{src:"/public/icons/arrow_backward_light_24.svg"})}),c.jsx(SS,{value:a,setValue:l,options:RA})]}),c.jsxs("form",{onSubmit:$e,children:[c.jsx(S0,{style:{marginTop:"24px"},children:"Название задачи"}),c.jsx(Ac,{style:{marginTop:"12px"},value:m,onChange:T=>x(T.target.value)}),c.jsx(S0,{style:{marginTop:"12px"},children:"Описание"}),c.jsx(yj,{style:{marginTop:"12px"},value:w,onChange:T=>k(T.target.value)}),c.jsxs(AA,{children:[c.jsx("img",{src:"/public/icons/person_gray.svg",style:{width:"24px",height:"24px"}}),Oe.map(T=>c.jsx(b1,{type:"button",avatarPath:T.photo?`${J}/${T.photo}`:void 0,name:`${T.first_name} ${T.second_name}`,onClick:()=>{q(Oe.filter(z=>z.id!==T.id))}})),c.jsxs(Ki,{style:{position:"relative"},onClick:T=>{T.preventDefault(),y(!0)},children:[c.jsx("img",{src:"/public/icons/plus_gray_20.svg"}),v&&c.jsx(eS,{setIsQueryDropdown:y,style:{position:"absolute",top:"0",left:"0",zIndex:1e4},children:f==null?void 0:f.members.filter(T=>T.id!==o.id).map(T=>Oe.includes(T)?c.jsx(c.Fragment,{}):c.jsx(tS,{avatarUrl:T.photo?`${J}/${T.photo}`:void 0,name:T.first_name+" "+T.second_name,onClick:()=>{q([T,...Oe])}}))})]})]}),c.jsxs(FA,{children:[c.jsx("img",{src:"/public/icons/schedule_light_24.svg",style:{width:"24px",height:"24px"}}),!_&&!D&&c.jsx(Ki,{onClick:T=>{T.preventDefault(),S(!h)},children:c.jsx("img",{src:"/public/icons/plus_gray_20.svg"})}),_&&D&&c.jsx(Ki,{style:{width:"fit-content",padding:"4px 8px 4px 8px"},onClick:T=>{T.preventDefault(),S(!h)},children:_+" - "+D}),h&&c.jsx(LA,{ref:ce,children:c.jsx(Zw,{date:L,setDate:Z,close:()=>{S(!1)},startStringDate:_,endStringDate:D,setStartStringDate:E,setEndStringDate:O})})]}),c.jsxs(zA,{children:[c.jsx("img",{src:"/public/icons/piechart_gray_24.svg"}),c.jsx(po,{color:"#33383F",bgColor:f?f.color:"#FFBC99",children:f&&f.name})]}),c.jsxs(WA,{children:[c.jsxs(TA,{type:"button",onClick:Se,children:[c.jsx("div",{children:"Удалить"}),c.jsx("img",{src:"/public/icons/trash_red_24.svg"})]}),c.jsx(Je,{type:"submit",style:{padding:"12px 68px 12px 68px"},disabled:K,children:"Сохранить"})]})]})]})]})},ll=async e=>await re({method:"get",url:J+"/user",headers:{Authorization:`Bearer ${e}`},validateStatus:function(n){return n<500},timeout:3e3}),id=async(e,t)=>{const n=new FormData;return t.email&&n.append("email",t.email),t.photo&&n.append("photo",t.photo),t.photo===null&&n.append("photo","null"),t.first_name&&n.append("first_name",t.first_name),t.second_name&&n.append("second_name",t.second_name),t.old_password&&n.append("old_password",t.old_password),t.new_password&&n.append("new_password",t.new_password),await re.put(J+"/user",n,{headers:{Authorization:`Bearer ${e}`},validateStatus:function(i){return i<500}})},UA=async e=>re.put(J+"/user/delete_photo",{},{headers:{Authorization:`Bearer ${e}`},validateStatus:function(n){return n<500}}),HA={user:{id:NaN,photo:null,email:"",first_name:"",second_name:""}},Rh=Ph({name:"userSlice",initialState:HA,reducers:{setUser(e,t){e.user=t.payload}}}),YA=Rh.reducer,qA=g.div`
      width: 100%;
      height: 100%;
...
`,f6=g.div`
      ...
      line-height: 16px;
      letter-spacing: -0.01em;
`,p6=({chatType:e,isIncomingMessage:t,senderAvatarURL:n,senderName:r,textContent:i,messageTime:s,reactions:o,chatId:a,messageId:l,myUserId:u})=>c.jsxs(a6,{isIncomingMessage:t,children:[t&&e=="group"&&c.jsx(jr,{src:n}),c.jsxs(l6,{isIncomingMessage:t,children:[c.jsx(c6,{isIncomingMessage:t,children:r}),c.jsx(u6,{children:i}),c.jsxs(d6,{children:[c.jsx(f6,{children:s}),o.map(d=>c.jsx(o6,{chatId:a,messageId:l,reaction:d.content,users:d.senders,myUserId:u,reactionId:d.id})),c.jsx(n6,{isIncoming:t,messageId:l,chatId:a})]})]})]}),h6=g.div`
      width: 40px;
      height: 40px;
      border-radius: 40px;
      display: flex;
...
`,$0=g.img`
      width: 24px;
      height: 24px;
`,I0=({isActive:e,iconPath:t,iconPathActive:n,onClick:r})=>c.jsx(h6,{onClick:r,children:e?c.jsx($0,{src:n}):c.jsx($0,{src:t})}),g6=g.div`
      display: flex;
      flex-direction: row;
      justify-content: flex-start;
      align-items: flex-start;
...
`,C6=g.div`
      ...
      line-height: 16px;
      letter-spacing: -0.01em;
`,E6=({chatType:e,isIncomingMessage:t,senderAvatarURL:n,senderName:r,messageTime:i,message:s})=>c.jsxs(x6,{isIncomingMessage:t,children:[t&&e=="group"&&c.jsx(jr,{src:n}),c.jsxs(v6,{isIncomingMessage:t,children:[c.jsx(w6,{isIncomingMessage:t,children:r}),c.jsxs(S6,{children:[c.jsx("a",{href:`${J}/${s.file_path}`,download:!0,children:c.jsx(Je,{style:{borderRadius:"50%"},onClick:()=>{},children:c.jsx("img",{src:"/public/icons/file_light.svg"})})}),c.jsxs(b6,{children:[c.jsx(k6,{children:s.file_name}),c.jsx(_6,{children:s.file_size+" Bytes"})]})]}),c.jsx(D6,{children:c.jsx(C6,{children:i})})]})]}),j6=g.div`
      align-self: ${e=>e.isIncomingMessage===!1?"flex-end":"flex-start"};
      display: flex;
      max-width: 87%;
      width: fit-content;
...
`,M6=g.div`
      ...
      line-height: 16px;
      letter-spacing: -0.01em;
`,N6=({chatType:e,isIncomingMessage:t,senderAvatarURL:n,message:r})=>c.jsxs(j6,{isIncomingMessage:t,children:[t&&e=="group"&&c.jsx(jr,{src:n}),c.jsxs(O6,{isIncomingMessage:t,children:[c.jsx(P6,{isIncomingMessage:t,children:`${r.sender.first_name} ${r.sender.second_name}`}),c.jsx(T6,{src:`${J}/${r.file_path}`,isIncomingMessage:t}),c.jsx(R6,{children:c.jsx(M6,{children:`${new Date(r.timestamp).getHours()}:${ac(new Date(r.timestamp))}`})})]})]}),li=async e=>await re.get(`${J}/chats`,{headers:{Authorization:`Bearer ${e}`},validateStatus:function(n){return n<500}}),AS=async(e,t)=>{const n=new FormData;return n.append("type",t.type),n.append("members",JSON.stringify(t.members)),t.name?n.append("name",t.name):n.append("name","null"),t.photo&&n.append("photo",t.photo),await re.post(`${J}/chats`,n,{headers:{Authorization:`Bearer ${e}`},validateStatus:function(i){return i<500}})},$6=async(e,t,n)=>{const r=new FormData;return r.append("file",n),await re.post(`${J}/upload_file/${t}`,r,{headers:{Authorization:`Bearer ${e}`},validateStatus:function(s){return s<500}})},I6=async(e,t)=>await re.post(`${J}/chat/${t}/read`,{},{headers:{Authorization:`Bearer ${e}`},validateStatus:function(r){return r<500}}),A6=async(e,t)=>await re.post(`${J}/chat/${t}/leave`,{},{headers:{Authorization:`Bearer ${e}`},validateStatus:function(r){return r<500}}),F6=g.div`
...
`,Z6=g.div`
      ...
      padding-right: 12px;
      gap: 8px;
`,e5=({chatPhoto:e,chatName:t,chatId:n,setIsVisible:r,setChat:i})=>{const s=vt(),o=mi.actions.setChats,a=we(h=>h.chatsReducer.chats.find(S=>S.id===n)),l=we(h=>h.projectsReducer.projects),u=we(h=>h.userReducer.user),d=[];l.map(h=>{h.members.map(S=>{!d.find(v=>v.id===S.id)&&S.id!==u.id&&d.push(S)})});const[f,p]=b.useState(!1),m=b.useRef(null);b.useEffect(()=>{const h=({target:S})=>{var v;(v=m.current)!=null&&v.contains(S)||(console.log(S),r(!1))};return document.addEventListener("mousedown",h),()=>{document.removeEventListener("mousedown",h)}},[r]);const x=()=>{const h=window.localStorage.getItem("access_token");h&&A6(h,n).then(S=>{S.status===200&&li(h).then(v=>{v.status===200&&(i(void 0),s(o(v.data.chats)))}).catch(v=>console.log(v))}).catch(S=>console.log(S))};return c.jsxs(B6,{ref:m,children:[c.jsxs(U6,{children:[e&&c.jsx(jr,{style:{width:"56px",height:"56px"},src:e}),!e&&c.jsx(jr,{style:{width:"56px",height:"56px"}}),c.jsxs(H6,{children:[c.jsx(Y6,{children:t}),a.type==="group"&&c.jsxs(q6,{children:[a.members.length," участников"]})]})]}),c.jsx(A0,{style:{marginTop:"12px"}}),c.jsxs(V6,{style:{marginTop:"12px"},children:[c.jsx(F0,{children:"Уведомления"}),c.jsx(L6,{isActive:f,setIsActive:p})]}),c.jsx(A0,{style:{marginTop:"12px"}}),c.jsx(F0,{style:{paddingLeft:"12px",marginTop:"12px"},children:"Участники"}),c.jsx(G6,{style:{marginTop:"12px"},children:d.map(h=>c.jsxs(Q6,{children:[c.jsx(K6,{children:c.jsx(X6,{children:h.photo&&c.jsx("img",{src:`${J}/${h.photo}`})})}),c.jsx(J6,{children:`${h.first_name} ${h.second_name}`})]}))}),c.jsxs(Z6,{style:{marginTop:"24px",marginBottom:"12px"},children:[c.jsx(Je,{style:{flex:1},onClick:()=>{x(),r(!1)},children:"Покинуть чат"}),a.owner.id===u.id&&c.jsx(ps,{style:{color:"#EC545D",flex:1},children:"Удалить чат"})]})]})},t5=g.div`
      flex: 1;
      display: flex;
      flex-direction: column;
      overflow: visible;
...
`,c5=({chatId:e,setChat:t})=>{const n=vt(),r=mi.actions.setChats,i=we(h=>h.chatsReducer.chats.find(S=>S.id===e)),s=we(h=>h.userReducer.user),o=b.useRef(null),[a,l]=b.useState(""),[u,d]=b.useState(void 0),[f,p]=b.useState(!1),m=b.useRef(null);b.useEffect(()=>{m.current&&(m.current.scrollTop=m.current.scrollHeight)},[i]),b.useEffect(()=>{const h=window.localStorage.getItem("access_token");h&&I6(h,i.id).then(S=>{S.status===200&&li(h).then(v=>{n(r(v.data.chats))}).catch(v=>console.log(v))}).catch(S=>console.log(S))},[i.messages.length]),b.useEffect(()=>{var h;if(i.type==="direct"){const S=i.members.find(v=>v.id!==s.id);S!=null&&S.photo?d(`${J}/${(h=i.members.find(v=>v.id!==s.id))==null?void 0:h.photo}`):d(void 0),l(`${S==null?void 0:S.first_name} ${S==null?void 0:S.second_name}`)}i.type==="group"&&(l(i.name),i.photo&&d(`${J}/${i.photo}`))},[i]);const x=h=>{if(h.target.files){const S=h.target.files[0],v=window.localStorage.getItem("access_token");v&&$6(v,i.id,S).then(y=>{y.status===201&&console.log("Message sent!")}).catch()}};return c.jsxs(t5,{children:[c.jsxs(n5,{children:[u&&c.jsx(jr,{style:{width:"56px",height:"56px"},src:u}),!u&&c.jsx(jr,{style:{width:"56px",height:"56px"}}),c.jsxs(r5,{children:[c.jsx(s5,{children:a}),i.type==="group"&&c.jsxs(o5,{children:[i.members.length," участников"]})]}),c.jsxs(i5,{children:[c.jsx(I0,{iconPath:"/public/icons/search_black.svg",iconPathActive:"/public/icons/search_blue.svg",isActive:!1}),c.jsx(I0,{iconPath:"/public/icons/layout_black.svg",iconPathActive:"/public/icons/layout_blue.svg",isActive:f,onClick:()=>{p(!0)}}),f&&c.jsx(e5,{setChat:t,chatName:a,chatId:i.id,setIsVisible:p})]})]}),c.jsx(a5,{ref:m,children:i.messages.map(h=>{if(h.type==="text")return c.jsx(p6,{chatType:i.type,isIncomingMessage:h.sender.id!==s.id,senderName:`${h.sender.first_name} ${h.sender.second_name}`,textContent:h.content,messageTime:`${new Date(h.timestamp).getHours()}:${ac(new Date(h.timestamp))}`,senderAvatarURL:`${J}/${h.sender.photo}`,messageId:h.id,reactions:h.reactions,chatId:i.id,myUserId:s.id});if(h.type==="file")return c.jsx(E6,{chatType:i.type,isIncomingMessage:h.sender.id!==s.id,senderName:`${h.sender.first_name} ${h.sender.second_name}`,messageTime:`${new Date(h.timestamp).getHours()}:${ac(new Date(h.timestamp))}`,senderAvatarURL:`${J}/${h.sender.photo}`,message:h});if(h.type==="image")return c.jsx(N6,{chatType:i.type,isIncomingMessage:h.sender.id!==s.id,senderAvatarURL:`${J}/${h.sender.photo}`,message:h})})}),c.jsxs(l5,{children:[c.jsxs(L0,{onClick:()=>{o.current&&o.current.click()},style:{cursor:"pointer"},children:[c.jsx("img",{src:"/public/icons/fileadd_light.svg"}),c.jsx("input",{name:"photo",onChange:x,multiple:!1,ref:o,type:"file",hidden:!0})]}),c.jsx(L0,{children:c.jsx("img",{src:"/public/icons/smile_light.svg"})}),c.jsx(y6,{chatId:i.id})]})]})},u5=g.div`
      padding: 40px;
      background: #f4f4f4;
      height: 100%;
      display: flex;
...
`,x5=()=>{const e=vt(),t=mi.actions.setChats,n=Ze(),r=we(u=>u.chatsReducer.chats),[i,s]=b.useState(),[o,a]=b.useState(!1),l=b.useRef(null);return b.useEffect(()=>{const u=({target:d})=>{var f;(f=l.current)!=null&&f.contains(d)||a(!1)};return document.addEventListener("mousedown",u),()=>{document.removeEventListener("mousedown",u)}},[]),b.useLayoutEffect(()=>{const u=window.localStorage.getItem("access_token");u&&li(u).then(d=>{d.status===200&&e(t(d.data.chats))}).catch(d=>console.log(d))},[]),c.jsxs(u5,{children:[c.jsx(d5,{children:"Сообщения"}),c.jsxs(f5,{children:[c.jsxs(p5,{children:[c.jsx(g5,{onClick:()=>{a(!o)},style:{padding:"16px",width:"fit-content",height:"fit-content",borderRadius:"50%",position:"absolute",bottom:"84px",right:"12px",zIndex:"2"},children:o?c.jsx("img",{src:"/public/icons/close_light.svg"}):c.jsx("img",{src:"/public/icons/group_light.svg"})}),o&&c.jsxs(h5,{ref:l,style:{zIndex:"2"},children:[c.jsxs(m5,{onClick:()=>{n("/messages/newgroup")},children:[c.jsx("img",{}),c.jsx("div",{children:"Новая группа"})]}),c.jsxs(y5,{onClick:()=>{n("/messages/newdirect")},children:[c.jsx("img",{}),c.jsx("div",{children:"Новое сообщение"})]})]}),c.jsx(Jo,{style:{position:"absolute",bottom:"12px",zIndex:"1"}}),c.jsx("div",{style:{overflow:"auto"},children:r&&r.map(u=>c.jsx(cF,{chat:u,isActive:i?u.id===i.id:!1,onClick:()=>s(u)}))})]}),i&&c.jsx(c5,{chatId:i.id,setChat:s})]})]})},v5=g.div`
      padding: 40px;
      background: #f4f4f4;
      height: 100%;
      display: flex;
...
`,P5=g.div`
      ...
      top: -2px;
      left: -2px;
`,T5=()=>{const e=Ze(),t=we(s=>s.projectsReducer.projects),n=we(s=>s.userReducer.user),r=[];t.map(s=>{s.members.map(o=>{!r.find(a=>a.id===o.id)&&o.id!==n.id&&r.push(o)})});const i=s=>{const o=window.localStorage.getItem("access_token"),a={type:"direct",members:[n.id,s.id]};o&&AS(o,a).then(l=>{l.status===200&&setTimeout(()=>e("/messages"),300)})};return c.jsxs(v5,{children:[c.jsx(w5,{children:"Сообщения"}),c.jsxs(S5,{children:[c.jsxs(k5,{children:[c.jsxs(_5,{children:[c.jsx("img",{src:"/public/icons/arrow_backward_light_24.svg",style:{cursor:"pointer"},onClick:()=>{e("/messages")}}),c.jsx(Jo,{})]}),c.jsx(D5,{style:{marginTop:"12px"},children:r.map(s=>c.jsxs(C5,{onClick:()=>{i(s)},children:[c.jsxs(E5,{children:[c.jsx(j5,{children:s.photo&&c.jsx("img",{src:`${J}/${s.photo}`})}),s.is_online&&c.jsx(P5,{})]}),c.jsx(O5,{children:`${s.first_name} ${s.second_name}`})]}))})]}),c.jsx(b5,{})]})]})},LS=g.div`
      width: 96px;
      height: 96px;
...
`,z0=({avatarPath:e,...t})=>e?c.jsxs(M5,{...t,children:[c.jsx("img",{src:e,style:{objectFit:"cover"}}),c.jsx(LS,{children:c.jsx("img",{src:"/public/icons/trash_white_48.svg",style:{width:"48px"}})})]}):c.jsx(R5,{...t,children:c.jsx("img",{src:"/public/icons/camera_white_48.svg",style:{width:"48px"}})}),N5=g.div`
      padding: 40px;
      background: #f4f4f4;
      height: 100%;
      display: flex;
...
`,q5=g.div`
      ...
      gap: 8px;
      overflow: auto;
`,V5=()=>{const e=Ze(),t=vt(),n=mi.actions.setChats,r=we(_=>_.projectsReducer.projects),i=we(_=>_.userReducer.user),s=[];r.map(_=>{_.members.map(E=>{!s.find(D=>D.id===E.id)&&E.id!==i.id&&s.push(E)})});const o=b.useRef(null),[a,l]=b.useState(void 0),[u,d]=b.useState(void 0),[f,p]=b.useState(""),[m,x]=b.useState([]),[h,S]=b.useState(1),[v,y]=b.useState(!0),w=_=>{x(E=>E.some(D=>D.id===_.id)?E.filter(D=>D.id!==_.id):[...E,_])};b.useEffect(()=>{f.length>0&&m.length>0?y(!1):y(!0)},[m,f]),b.useEffect(()=>{a&&d(URL.createObjectURL(a))},[a]);const k=()=>{const _=window.localStorage.getItem("access_token"),E={type:"group",name:f,members:m.map(D=>D.id),photo:a};_&&AS(_,E).then(D=>{console.log(D),D.status===200&&(li(_).then(O=>{t(n(O.data.chats))}).catch(),setTimeout(()=>e("/messages"),300))}).catch(D=>console.log(D))};return c.jsxs(N5,{children:[c.jsx($5,{children:"Сообщения"}),c.jsxs(I5,{children:[h===1&&c.jsxs(W0,{children:[c.jsxs(B0,{children:[c.jsx("img",{src:"/public/icons/arrow_backward_light_24.svg",style:{cursor:"pointer"},onClick:()=>{e("/messages")}}),c.jsx("div",{children:"Добавление участников"})]}),c.jsx(L5,{children:c.jsx(Jo,{})}),c.jsx(F5,{style:{marginTop:"12px"}}),c.jsx(z5,{children:s.map(_=>c.jsxs(U0,{children:[c.jsx(W5,{type:"checkbox",checked:m.some(E=>E.id===_.id),onChange:()=>w(_)}),c.jsxs(H0,{style:{marginLeft:"24px"},children:[c.jsx(Y0,{children:_.photo&&c.jsx("img",{src:`${J}/${_.photo}`})}),_.is_online&&c.jsx(q0,{})]}),c.jsx(V0,{style:{marginLeft:"12px"},children:`${_.first_name} ${_.second_name}`})]}))}),c.jsx(G0,{onClick:()=>{S(2),x([i,...m])},children:c.jsx("img",{src:"/public/icons/arrow_forward_white_24.svg"})})]}),h===2&&c.jsxs(W0,{children:[c.jsxs(B0,{children:[c.jsx("img",{src:"/public/icons/arrow_backward_light_24.svg",style:{cursor:"pointer"},onClick:()=>{S(1),x([])}}),c.jsx("div",{children:"Новая группа"})]}),c.jsxs(B5,{children:[a&&c.jsx(z0,{style:{cursor:"pointer"},onClick:()=>{o.current&&o.current.click()},avatarPath:u}),!a&&c.jsx(z0,{style:{cursor:"pointer"},onClick:()=>{o.current&&o.current.click()}}),c.jsx("input",{name:"photo",onChange:_=>{const E=_.target.files;E&&l(E[0])},multiple:!1,ref:o,type:"file",hidden:!0})]}),c.jsxs("div",{style:{marginTop:"12px"},children:[c.jsx(U5,{children:"Название группы"}),c.jsx(Gr,{value:f,onChange:_=>{p(_.target.value)},style:{marginTop:"12px"}})]}),c.jsxs(H5,{children:[c.jsx(Y5,{children:m.length+" участника"}),c.jsx(q5,{children:m.map(_=>c.jsxs(U0,{children:[c.jsxs(H0,{children:[c.jsx(Y0,{children:_.photo&&c.jsx("img",{src:`${J}/${_.photo}`})}),_.is_online&&c.jsx(q0,{})]}),c.jsx(V0,{style:{marginLeft:"12px"},children:`${_.first_name} ${_.second_name}`})]}))})]}),c.jsx(G0,{disabled:v,onClick:k,children:c.jsx("img",{src:"/public/icons/arrow_forward_white_24.svg"})})]}),c.jsx(A5,{})]})]})},G5=g.div`
      background: #f4f4f4;
      padding: 40px 40px 6px 40px;
      width: 100%;
      height: 100%;
...
`,X5=g.div`
      width: 600px;
`,J5=()=>{const e=vt(),t=xn.actions.setProjects,[n,r]=b.useState(),[i,s]=b.useState(""),[o,a]=b.useState(!0),l=d=>{d.target.validity.valid&&n?a(!1):a(!0),s(d.target.value)},u=d=>{d.preventDefault();const f=window.localStorage.getItem("access_token");f&&n&&HN(f,n==null?void 0:n.id,i).then(p=>{console.log(p),p.status===200&&mn(f).then(m=>{e(t(m.data.projects))}).catch()})};return c.jsxs(G5,{children:[c.jsx(Q5,{children:"Менеджер проектов"}),c.jsx(K5,{children:c.jsx("form",{onSubmit:u,children:c.jsxs(X5,{children:[c.jsx(an,{children:"Email"}),c.jsx(Ac,{style:{marginTop:"12px"},type:"email",value:i,onChange:l}),c.jsx(an,{style:{marginBottom:"12px",marginTop:"12px"},children:"Проект"}),c.jsx(yS,{setValue:r,value:n}),c.jsx(Je,{style:{width:"fit-content",marginTop:"24px"},disabled:o,type:"submit",children:"Добавить пользователя"})]})})})]})},Z5=()=>{const e=vt(),t=mi.actions.setChats,n=mi.actions.setNewMessage,r=xn.actions.setProjects,{isAuth:i,setIsAuth:s}=b.useContext(Ko),[o,a]=b.useState(me.connected),l=window.localStorage.getItem("access_token"),u=we(d=>d.chatsReducer.chats);return b.useLayoutEffect(()=>{const d=window.localStorage.getItem("access_token");ll(d).then(f=>{if(f.status===200){const p=Rh.actions.setUser;e(p(f.data)),s(!0)}else s(!1)}).catch(f=>{s(!1),console.log(f)}),i&&(li(d).then(f=>{f.status===200&&e(t(f.data.chats))}).catch(f=>console.log(f)),mn(d).then(f=>{f.status===200&&e(r(f.data.projects))}).catch(f=>console.log(f)))},[i]),b.useEffect(()=>(i&&l&&l.length>0&&(me.on("connect",()=>{console.log("Connected "+me.id),a(!0)}),me.on("disconnect",(d,f)=>{console.log(d),console.log(f),a(!1),me.connect()}),me.on("new_message",d=>{var f;(f=u.find(p=>p.id===d.chat.id))!=null&&f.messages.find(p=>p.id===d.message_id)||e(n(d))}),me.on("set_reaction",()=>{const d=window.localStorage.getItem("access_token");d&&li(d).then(f=>{e(t(f.data.chats))}).catch()}),me.on("remove_reaction",()=>{const d=window.localStorage.getItem("access_token");d&&li(d).then(f=>{e(t(f.data.chats))}).catch()}),me.auth={token:l},me.connect()),i===!1&&(me.disconnect(),me.off("connect"),me.off("disconnect"),me.off("new_message"),me.off("set_reaction"),me.off("remove_reaction"),me.auth={}),()=>{me.disconnect(),me.off("connect"),me.off("disconnect"),me.off("new_message"),me.off("set_reaction"),me.off("remove_reaction"),me.auth={}}),[i]),b.useEffect(()=>{o&&u.map(d=>{me.emit("begin_chat",{chat_id:d.id})})},[o,u.length]),i?c.jsx(nm,{children:c.jsxs(lt,{element:c.jsx(S3,{}),path:"/",children:[c.jsx(lt,{path:"/home",element:c.jsx(C3,{})}),c.jsx(lt,{path:"/messages",element:c.jsx(x5,{})}),c.jsx(lt,{path:"/messages/newdirect",element:c.jsx(T5,{})}),c.jsx(lt,{path:"/messages/newgroup",element:c.jsx(V5,{})}),c.jsx(lt,{path:"/tasks",element:c.jsx(mI,{})}),c.jsx(lt,{path:"/tasks/:id",element:c.jsx(OA,{})}),c.jsx(lt,{path:"/tasks/:id/settings",element:c.jsx(BA,{})}),c.jsx(lt,{path:"/projects",element:c.jsx(WI,{})}),c.jsx(lt,{path:"/projects/adduser",element:c.jsx(J5,{})}),c.jsx(lt,{path:"/account",element:c.jsx(ZA,{})}),c.jsx(lt,{path:"*",element:c.jsx(tm,{to:"/home"})})]})}):c.jsxs(nm,{children:[c.jsx(lt,{path:"/register",element:c.jsx(dE,{})}),c.jsx(lt,{path:"/login",element:c.jsx(EE,{})}),c.jsx(lt,{path:"*",element:c.jsx(tm,{to:"/login"})})]})},eL=fD`
* {
  margin: 0;
  padding: 0;
...
`;function tL(){return c.jsx(c.Fragment,{children:c.jsxs(fE,{children:[c.jsx(eL,{}),c.jsx(d2,{children:c.jsx(Z5,{})})]})})}const nL=rS({chatsReducer:W6,userReducer:YA,projectsReducer:G$}),rL=()=>j$({reducer:nL}),iL=rL();ld.createRoot(document.getElementById("root")).render(c.jsx($t.StrictMode,{children:c.jsx(QE,{store:iL,children:c.jsx(tL,{})})}));
